...
## Overview
@vitejs/plugin-react is part of the Orchestrace stack and should be used with explicit conventions so implementation remains reliable, maintainable, and easy to review.

## Why It Matters in This Repo
- Package/technology: `@vitejs/plugin-react`
...
1. Read this guide before implementing changes in files that rely on @vitejs/plugin-react.
...
- Using @vitejs/plugin-react features inconsistently across packages.
...
## Definition of Done for @vitejs/plugin-react Changes
