# @eslint/js Best Practices

## Overview
@eslint/js is part of the Orchestrace stack and should be used with explicit conventions so implementation remains reliable, maintainable, and easy to review.

## Why It Matters in This Repo
- Package/technology: `@eslint/js`
...
1. Read this guide before implementing changes in files that rely on @eslint/js.
...
- Using @eslint/js features inconsistently across packages.
...
## Definition of Done for @eslint/js Changes
