...
## Overview
@mariozechner/pi-ai is part of the Orchestrace stack and should be used with explicit conventions so implementation remains reliable, maintainable, and easy to review.

## Why It Matters in This Repo
- Package/technology: `@mariozechner/pi-ai`
...
- For AI integrations, prioritize observability, retries, and cost/token control.
- Validate model output shape before acting on it in pipelines.

## Recommended Workflow
1. Read this guide before implementing changes in files that rely on @mariozechner/pi-ai.
...
- Using @mariozechner/pi-ai features inconsistently across packages.
...
## Definition of Done for @mariozechner/pi-ai Changes
