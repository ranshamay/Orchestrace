...
## Overview
tailwind-merge is part of the Orchestrace stack and should be used with explicit conventions so implementation remains reliable, maintainable, and easy to review.

## Why It Matters in This Repo
- Package/technology: `tailwind-merge`
...
1. Read this guide before implementing changes in files that rely on tailwind-merge.
...
- Using tailwind-merge features inconsistently across packages.
...
## Definition of Done for tailwind-merge Changes
