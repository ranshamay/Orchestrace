...
## Overview
eslint-plugin-react-refresh is part of the Orchestrace stack and should be used with explicit conventions so implementation remains reliable, maintainable, and easy to review.

## Why It Matters in This Repo
- Package/technology: `eslint-plugin-react-refresh`
...
- Treat linting/formatting as automated policy: avoid ad-hoc local overrides.
- Document any rule relaxation with context and concrete boundaries.

## Recommended Workflow
1. Read this guide before implementing changes in files that rely on eslint-plugin-react-refresh.
...
- Using eslint-plugin-react-refresh features inconsistently across packages.
...
## Definition of Done for eslint-plugin-react-refresh Changes
