...
## Overview
JavaScript is part of the Orchestrace stack and should be used with explicit conventions so implementation remains reliable, maintainable, and easy to review.

## Why It Matters in This Repo
- Package/technology: `javascript`
...
1. Read this guide before implementing changes in files that rely on JavaScript.
...
- Using JavaScript features inconsistently across packages.
...
## Definition of Done for JavaScript Changes
