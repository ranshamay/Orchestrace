...
## Overview
Node.js is part of the Orchestrace stack and should be used with explicit conventions so implementation remains reliable, maintainable, and easy to review.

## Why It Matters in This Repo
- Package/technology: `nodejs`
...
- Treat process lifecycle, signal handling, and resource cleanup as first-class concerns.
- Use Node built-in modules via `node:` imports for clarity and tooling friendliness.

## Recommended Workflow
1. Read this guide before implementing changes in files that rely on Node.js.
...
- Using Node.js features inconsistently across packages.
...
## Definition of Done for Node.js Changes
