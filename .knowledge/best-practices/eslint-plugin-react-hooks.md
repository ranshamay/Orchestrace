...
## Overview
eslint-plugin-react-hooks is part of the Orchestrace stack and should be used with explicit conventions so implementation remains reliable, maintainable, and easy to review.

## Why It Matters in This Repo
- Package/technology: `eslint-plugin-react-hooks`
...
1. Read this guide before implementing changes in files that rely on eslint-plugin-react-hooks.
...
- Using eslint-plugin-react-hooks features inconsistently across packages.
...
## Definition of Done for eslint-plugin-react-hooks Changes
