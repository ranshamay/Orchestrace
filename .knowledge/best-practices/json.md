...
## Overview
JSON is part of the Orchestrace stack and should be used with explicit conventions so implementation remains reliable, maintainable, and easy to review.

## Why It Matters in This Repo
- Package/technology: `json`
...
1. Read this guide before implementing changes in files that rely on JSON.
...
- Using JSON features inconsistently across packages.
