...
## Overview
js-tiktoken is part of the Orchestrace stack and should be used with explicit conventions so implementation remains reliable, maintainable, and easy to review.

## Why It Matters in This Repo
- Package/technology: `js-tiktoken`
...
1. Read this guide before implementing changes in files that rely on js-tiktoken.
...
- Using js-tiktoken features inconsistently across packages.
...
## Definition of Done for js-tiktoken Changes
