# Shell (Bash/Zsh) Best Practices

## Overview
Shell (Bash/Zsh) is part of the Orchestrace stack and should be used with explicit conventions so implementation remains reliable, maintainable, and easy to review.
...
1. Read this guide before implementing changes in files that rely on Shell (Bash/Zsh).
...
- Using Shell (Bash/Zsh) features inconsistently across packages.
...
## Definition of Done for Shell (Bash/Zsh) Changes
