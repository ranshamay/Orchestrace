# Autoprefixer Best Practices

## Overview
Autoprefixer is part of the Orchestrace stack and should be used with explicit conventions so implementation remains reliable, maintainable, and easy to review.

## Why It Matters in This Repo
- Package/technology: `autoprefixer`
...
- Keep build config minimal and composable; avoid hidden magic in custom scripts.
- Prefer declarative config and documented defaults over ad-hoc CLI flags.

## Recommended Workflow
1. Read this guide before implementing changes in files that rely on Autoprefixer.
...
- Using Autoprefixer features inconsistently across packages.
...
## Definition of Done for Autoprefixer Changes
