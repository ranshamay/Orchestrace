...
## Overview
Prettier is part of the Orchestrace stack and should be used with explicit conventions so implementation remains reliable, maintainable, and easy to review.

## Why It Matters in This Repo
- Package/technology: `prettier`
...
1. Read this guide before implementing changes in files that rely on Prettier.
...
- Using Prettier features inconsistently across packages.
...
## Definition of Done for Prettier Changes
