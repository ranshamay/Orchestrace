...
## Overview
pnpm Workspaces is part of the Orchestrace stack and should be used with explicit conventions so implementation remains reliable, maintainable, and easy to review.

## Why It Matters in This Repo
- Package/technology: `pnpm`
...
- Design scripts and package boundaries for incremental builds and cache-friendly execution.
- Use workspace-aware filters to run only the necessary subset of tasks.

## Recommended Workflow
1. Read this guide before implementing changes in files that rely on pnpm Workspaces.
...
- Using pnpm Workspaces features inconsistently across packages.
...
## Definition of Done for pnpm Workspaces Changes
