...
## Overview
Class Variance Authority (CVA) is part of the Orchestrace stack and should be used with explicit conventions so implementation remains reliable, maintainable, and easy to review.

## Why It Matters in This Repo
- Package/technology: `class-variance-authority`
...
- Wrap utility libraries in small local helpers when that improves consistency.
- Keep utility usage predictable across the codebase to reduce cognitive load.

## Recommended Workflow
1. Read this guide before implementing changes in files that rely on Class Variance Authority (CVA).
...
- Using Class Variance Authority (CVA) features inconsistently across packages.
...
## Definition of Done for Class Variance Authority (CVA) Changes
