...
## Overview
Shell Deployment Scripts is part of the Orchestrace stack and should be used with explicit conventions so implementation remains reliable, maintainable, and easy to review.

## Why It Matters in This Repo
- Package/technology: `shell`
...
- Infrastructure workflows must be auditable, reviewable, and safe-by-default.
- Plan/apply separation, state hygiene, and rollback strategy are non-negotiable.

## Recommended Workflow
1. Read this guide before implementing changes in files that rely on Shell Deployment Scripts.
...
- Using Shell Deployment Scripts features inconsistently across packages.
...
## Definition of Done for Shell Deployment Scripts Changes
