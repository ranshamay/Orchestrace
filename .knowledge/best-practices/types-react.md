# @types/react + @types/react-dom Best Practices

## Overview
@types/react + @types/react-dom is part of the Orchestrace stack and should be used with explicit conventions so implementation remains reliable, maintainable, and easy to review.

## Why It Matters in This Repo
- Package/technology: `@types/react`
...
- Developer tooling should reduce friction while preserving production parity.
- Align local runtime behavior with CI behavior wherever possible.

## Recommended Workflow
1. Read this guide before implementing changes in files that rely on @types/react + @types/react-dom.
...
- Using @types/react + @types/react-dom features inconsistently across packages.
...
## Definition of Done for @types/react + @types/react-dom Changes
