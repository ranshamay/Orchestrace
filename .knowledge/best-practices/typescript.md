...
## Overview
TypeScript is part of the Orchestrace stack and should be used with explicit conventions so implementation remains reliable, maintainable, and easy to review.

## Why It Matters in This Repo
- Package/technology: `typescript`
...
1. Read this guide before implementing changes in files that rely on TypeScript.
...
function isTerminal(status: RunStatus): status is 'success' | 'failed' {
...
- Using TypeScript features inconsistently across packages.
...
## Definition of Done for TypeScript Changes
