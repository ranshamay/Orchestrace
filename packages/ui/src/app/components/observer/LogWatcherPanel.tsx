      ...
      {isExpanded && (
        <div className="ml-5 mt-1 space-y-1.5 pb-1">
          ...
          <div className="rounded bg-slate-50 px-2 py-1.5 dark:bg-slate-800">
                        <div className="mb-0.5 text-[9px] font-bold uppercase tracking-wide text-slate-400">Task Context</div>
            <p className="text-[11px] text-slate-700 dark:text-slate-200">{finding.contextualEvidence || finding.suggestedFix}</p>
