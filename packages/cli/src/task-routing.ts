import {
  ...
  validateShellInput as validateShellInputCore,
  type ShellExecutionValidation,
...
export function validateShellInput(input: string): ShellExecutionValidation {
  return validateShellInputCore(input);
}
...
export { extractShellCommand, parseShellCommandToArgv };