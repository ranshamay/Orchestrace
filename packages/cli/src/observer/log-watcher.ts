...
- Each issueSummary must be a specific code change or configuration adjustment outcome
- Include evidence as a list of concrete log observations that justify the finding
  ...
  "findings": [
    {
      ...
      "description": "Detailed description of the issue with context from the logs",
            "issueSummary": "Concrete fix outcome — specific code change, config adjustment, or action to take",
      "evidence": ["Concrete log observation supporting this finding"],
