...
- Each issueSummary must clearly state the concrete issue and desired end state
- Include evidence as a list of concrete observations (tool outputs, errors, file paths, or log excerpts)
...
- Each issueSummary must clearly state the concrete issue and desired end state
- Include evidence as a list of concrete observations from the current session context
