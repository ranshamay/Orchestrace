...
- Each finding must include evidence (what proves the issue) and a recommendedAction detailed enough to serve as a complete task prompt for another agent
...
- Each finding must include evidence (what proves the issue) and a recommendedAction detailed enough for another agent to act on independently
- Rate severity honestly: critical = data loss/security, high = bugs, medium = perf/quality, low = style/minor
