...
- Each contextualEvidence must be detailed enough to serve as a complete task prompt for another agent
...
- Each contextualEvidence must be detailed enough for another agent to act on independently
