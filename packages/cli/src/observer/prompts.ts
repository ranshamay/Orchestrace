...
- Each finding must include a concise issueSummary and concrete evidence entries (logs, traces, code refs)
- issueSummary should be detailed enough to serve as a complete task prompt for another agent
...
- Each finding must include a concise issueSummary and concrete evidence entries (logs, traces, code refs)
- issueSummary should be detailed enough for another agent to act on independently
- Rate severity honestly: critical = data loss/security, high = bugs, medium = perf/quality, low = style/minor
