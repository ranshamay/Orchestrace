...
- Provide a clear issueSummary, 2-3 concrete evidence bullets, and a severityRationale detailed enough for another agent to act on
...
- Provide a clear issueSummary, 2-3 concrete evidence bullets, and a severityRationale another agent can act on independently
- Rate severity honestly: critical = data loss/security, high = bugs, medium = perf/quality, low = style/minor
