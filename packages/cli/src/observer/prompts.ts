...
- Include an evidence array with concise factual snippets that justify the finding
...
- Include an evidence array with concise factual snippets from the observed session
