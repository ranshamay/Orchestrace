...
- Each finding must include "issueSummary" and "evidence" fields detailed enough to drive a complete implementation task
...
- Each finding must include "issueSummary" and "evidence" detailed enough for another agent to act on independently
