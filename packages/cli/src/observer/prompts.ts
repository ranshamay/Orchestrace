...
- Each finding must include concrete evidence and a detailed recommendedAction that can serve as a complete task prompt for another agent
...
- Each finding must include concrete evidence and a detailed recommendedAction for another agent to act on independently
