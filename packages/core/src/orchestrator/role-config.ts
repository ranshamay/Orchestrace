  ...
  const phaseRules =
    role === 'planner'
      ...
      : [
          ...
          'Prefer targeted read_file/read_files calls for known paths from planning.',
          'If grep-like discovery is still needed, use run_command with grep/find rather than relying on search_files.',
          'Do not use run_command or run_command_batch as substitutes for targeted file reads when sufficient context is already gathered; proceed directly to edits.',
