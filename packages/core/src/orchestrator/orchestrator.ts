  ...
  const phaseRules =
    phase === 'planning'
      ? [
          ...
          'Before using repository-state tools (git_status/git_diff) or writing rollback notes, classify task intent as read-only vs write.',
          'If task analysis indicates no file writes/state changes are needed, skip git_status/git_diff and mark rollback/risk as N/A.',
